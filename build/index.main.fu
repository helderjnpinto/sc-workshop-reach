      ...
      .timeout(Left v316, {
        ...
        publish(@thisConsensusTime/306)
          ...
          .recv({
            ...
            transfer.(balance(0)/477, Nothing).to(v303);
            let v482;
            const v483* = v481;
            ...
            .timeout(Left v347, {
              ...
              publish(@thisConsensusTime/326)
                ...
                .recv({
                  ...
                  transfer.(balance(0)/445, Nothing).to(v320);
                  let v450;
                  const v451* = v449;
                ...
                .timeout(Left v367, {
                  ...
                  publish(@thisConsensusTime/357)
                    ...
                    .recv({
                      ...
                      transfer.(balance(0)/426, Nothing).to(v303);
                      let v431;
                      const v432* = v430;
                    ...
                    .timeout(Left v384, {
                      ...
                      publish(@thisConsensusTime/374)
                        ...
                        .recv({
                          ...
                          transfer.(balance(0)/407, Nothing).to(v320);
                          let v412;
                          const v413* = v411;
